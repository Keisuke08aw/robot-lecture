...
void tube0_callback(const std_msgs::Float32 &float_msg)
{
    target_tube[0] = float_msg.data;
}
void tube1_callback(const std_msgs::Float32 &float_msg)
{
    target_tube[1] = float_msg.data;
}
...
void jp()
{
    ...
    js0.name[14] = "tubeL_joint0";
    js0.name[15] = "tubeR_joint0";
    ...
    js0.position[13] = 0;
    js0.position[14] = target_tube[0];
    js0.position[15] = target_tube[1];
...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber tube0_sub = n.subscribe("tube0", 10, tube0_callback);
    ros::Subscriber tube1_sub = n.subscribe("tube1", 10, tube1_callback);
